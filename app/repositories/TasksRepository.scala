...
//import org.mongodb.scala.model.{FindOneAndUpdateOptions, ReplaceOptions}
//import play.api.Logging
//import uk.gov.hmrc.mongo.MongoComponent
//
//trait TasksRepository extends Logging {
//
...
////    key = Seq("lastUpdated" -> Indexes.Ascending),
...
////    MongoIndex(
////      key = Seq(newId -> Indexes.Ascending),
////      name = "internal-id-and-identifier-and-sessionId-compound-index"
////    )
////  } else {
////    MongoIndex(
////      key = Seq(internalIdKey -> Indexes.Ascending, identifierKey -> Indexes.Ascending),
